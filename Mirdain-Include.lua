...
Geomancy_List = M('Geo-Acumen', 'Geo-Attunement', 'Geo-Barrier', 'Geo-STR', 'Geo-DEX', 'Geo-VIT', 'Geo-AGI', 'Geo-INT',
    ...
    'Geo-Paralysis',
    'Geo-Poison', 'Geo-Precision', 'Geo-Refresh', 'Geo-Regen', 'Geo-Slip', 'Geo-Slow', 'Geo-Torpor', 'Geo-Vex',
...
do
    ...
    local default = {
        ...
        info = true,
        warn = true,
        Display_Box = { text = { size = 10, font = 'Consolas', red = 255, green = 255, blue = 255, alpha = 255 }, pos = { x = 2400, y = 1150 }, bg = { visible = true, red = 0, green = 0, blue = 0, alpha = 102 }, },
        Debug_Box = { text = { size = 10, font = 'Consolas', red = 255, green = 255, blue = 255, alpha = 255 }, pos = { x = 2200, y = 1150 }, bg = { visible = true, red = 0, green = 0, blue = 0, alpha = 102 }, },
    }
    ...
    windower.register_event('lose buff', function(id)
        ...
        if id == 15 then -- Doom
            --[[if Divergence_Zones:contains(world.area) then
                ...
                enable('main', 'sub', 'range', 'ammo', 'head', 'lear', 'rear', 'body', 'hands', 'lring', 'rring', 'waist',
                    'legs', 'feet')
            else
                Unlock()
            end]] --
